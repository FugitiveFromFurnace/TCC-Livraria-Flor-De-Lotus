...
--
-- Host: 127.0.0.1
-- Generation Time: 26-Nov-2018 às 19:13
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `prc_geraNotificacao` ()  begin
	...
	declare carregarLivroNotificacao cursor
		for select PEDIDO.idLivro ID, tituloLivro Titulo, sum(qtdePedido) Vendido, qtdeLivro Qtde_Disponivel from pedido inner join livros on pedido.idLivro = livros.idLivro inner join venda on idPedido = pedidoVenda where dataVenda >= date_sub(now(), interval 7 day) group by tituloLivro, livros.idLivro order by qtdePedido;
...
INSERT INTO `descontos` (`idDesconto`, `nomeDesconto`, `valorDesconto`, `tipoDesconto`) VALUES
(1, 'teste', '15.00', 'Direto');
...
INSERT INTO `notificacao` (`idNotificacao`, `livroNotificacao`, `qtdeRecomendada`) VALUES
(230, 63, 16),
(231, 57, 30),
(232, 65, 100);
...
-- em utilização(#1271 - Illegal mix of collations for operation 'case')
...
ALTER TABLE `avaliacoes`
  ...
  ADD KEY `idLivroAvaliacao` (`idLivroAvaliacao`),
  ADD KEY `idClienteAvaliacao` (`idClienteAvaliacao`);
...
ALTER TABLE `livros`
  ...
  ADD KEY `categoriaLivro` (`categoriaLivro`),
  ADD KEY `editoraLivro` (`editoraLivro`),
  ADD KEY `autorLivro` (`autorLivro`);
...
ALTER TABLE `venda`
  ...
  ADD KEY `pedidoVenda` (`pedidoVenda`);
...
--
ALTER TABLE `livros`
  MODIFY `idLivro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
--
-- AUTO_INCREMENT for table `notificacao`
--
ALTER TABLE `notificacao`
  MODIFY `idNotificacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=233;
--
-- AUTO_INCREMENT for table `venda`
--
ALTER TABLE `venda`
  MODIFY `idVenda` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;
--
...
--
ALTER TABLE `avaliacoes`
  ADD CONSTRAINT `avaliacoes_ibfk_1` FOREIGN KEY (`idLivroAvaliacao`) REFERENCES `livros` (`idLivro`),
  ADD CONSTRAINT `avaliacoes_ibfk_2` FOREIGN KEY (`idClienteAvaliacao`) REFERENCES `cliente` (`idCliente`);

--
-- Limitadores para a tabela `livros`
--
ALTER TABLE `livros`
  ADD CONSTRAINT `livros_ibfk_1` FOREIGN KEY (`categoriaLivro`) REFERENCES `categoria` (`idCategoria`),
  ADD CONSTRAINT `livros_ibfk_2` FOREIGN KEY (`editoraLivro`) REFERENCES `editora` (`idEditora`),
  ADD CONSTRAINT `livros_ibfk_3` FOREIGN KEY (`autorLivro`) REFERENCES `autor` (`idAutor`);

--
-- Limitadores para a tabela `pedido`
--
ALTER TABLE `pedido`
  ADD CONSTRAINT `pedido_ibfk_1` FOREIGN KEY (`idClientePedido`) REFERENCES `cliente` (`idCliente`);

--
-- Limitadores para a tabela `venda`
--
ALTER TABLE `venda`
  ADD CONSTRAINT `venda_ibfk_1` FOREIGN KEY (`idFunc`) REFERENCES `funcionario` (`idFuncionario`),
  ADD CONSTRAINT `venda_ibfk_2` FOREIGN KEY (`pedidoVenda`) REFERENCES `pedido` (`idPedido`);
